    ...
    const LineHeightButton=()=>{
      ...
      return(
        <DropdownMenu>
            ...
            <button className=
                    "h-7 min-w-7 shrink-0 flex flex-col items-center justify-between rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
 ...
 const FontSizeButton=()=>{
      ...
      return(
        <div className="flex items-center gap-x-0.5">
            ...
            onClick={decrement}
            className=
                    "h-7 w-7 shrink-0 flex items-center justify-between rounded-sm hover:bg-neutral-200/80 ">
    ...
    const ListButton=()=>{
      ...
      return(
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
            <button className=
                    "h-7 min-w-7 shrink-0 flex flex-col items-centre justify-between rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
...
const LinkButton=()=>{
    ...
    return(
        <DropdownMenu onOpenChange={(open)=>{
            ...
            <DropdownMenuContent className="p-2.55 flex items-center gap-x-2">
                <Input
...
const HighlightColorButton=()=>{
      ...
      return(
        <DropdownMenu>
            ...
            <DropdownMenuContent className="p-0.55">
                <SketchPicker
                color={value}
                onChange={onChange}
                />
    ...
    return(
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                className=
                    "h-7 min-w-[120px] shrink-0 flex items-centre justify-between rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-small" >
...
const HeadingLevelButton=()=>{
        ...
        return(
            ...
            <DropdownMenuTrigger asChild>
                <button
                className=
                    "h-7 min-w-7 shrink-0 flex items-centre justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm" >
                        <span className="truncate">
                    {getCurrentHeading()}
                        </span>
                        <ChevronDownIcon className="ml-2 size-4 shrink-0"/>
...
const ToolbarButton=({
    ...
    return(
        <button>
            <Icon onClick={onClick} className={cn(
...
export const Toolbar=()=>{
    ...
    return(
        <div className="bg-[#F1F4F9] px-2.0 py-0.5 min-h-[40px] flex items-center gap-x-2 overflow-x-auto">
            {sections[0].map((item)=>(
